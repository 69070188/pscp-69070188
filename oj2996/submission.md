...
อย่างแรกผมจะ 
input คำเข้ามา 
ต่อมาผมจะนำค่าที่เรา input มาเปลี่ยนเป็นตัวพิมเล็กด้วย.lower()
และแสดงผลย้อนหลังด้วยคำสั่ง print(name[:: -1])
```
...
```text
Step 1: input ข้อความ
Step 2: เปลี่ยนข้อความที่ input เป็นพิมพ์เล็ก
Step 3: แสดงผลให้อยู่ในรูปแบบย้อนกลับ
```
...
```text
วิธีสุดท้ายเหมือนวิธีแรก เพราะ ในข้อนี้ผมรู้วิธีการทำโจทย์อยู่แล้วครับเนื่องจากได้มาค่าย prepro 
```
