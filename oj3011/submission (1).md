...
Output:
แสดงผลเป็นสีที่ถูกผสมกัน

Constraints:
ถ้ามีสีอื่นที่ไม่ใช่แม่สีมาผสมค่าจะออกมาเป็น error
...
```text
Step 1: รับค่า input สีที่ 1
Step 2: รับค่า input สีที่ 2
Step 3: ถ้าสีสองสีไม่เหมือนกันจะแสดงผลเป็นสีที่ถูกผสมแล้ว
Step 4: ถ้าสีเหมือนกันจะแสดงผลออกมาเป็นสีเดิม
Step 5: ถ้ามีสีอื่นที่ไม่ใช่แม่สีมาผสมค่าจะออกมาเป็น error
...
```text
เหมือนแผนแรก เพราะว่าผมเข้าใจหลักการในการทำครับ 
```
...
```text
ทดสอบว่าถ้าไม่มีสีตามแม่สีที่กำหนดจะออกเป็น error ไหม
```
...
```text
ทดสอบว่าสีเหมือนกันผลจะออกมาเป็นสีเดิมไหม
```
