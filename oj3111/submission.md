...
```text
โจทย์ให้คำนวณยอดเงินสุทธิหลังหักส่วนลดจากการซื้อสินค้าในร้านสหกรณ์โรงเรียน โดยคำนวณจากยอดรวมราคาสินค้าทั้งหมด แล้วนำมาคิดส่วนลดตามเงื่อนไขดังนี้:
เป็นสมาชิก ('Y'): ได้รับส่วนลด 5% จากยอดรวม
ไม่เป็นสมาชิก ('N') แต่ยอดรวม >= 500 บาท: ได้รับส่วนลด 3% จากยอดรวม
กรณีอื่น ๆ (ไม่เป็นสมาชิกและยอดรวม < 500 บาท): ไม่ได้รับส่วนลด
```
...
```text
Step 1: รับค่าสถานะสมาชิก ('Y' หรือ 'N') และจำนวนรายการสินค้า n
Step 2: ใช้ loop ในการรับราคาสินค้า n รายการ แล้วนำมาบวกสะสมไว้ในตัวแปร total
Step 3: ตรวจสอบสถานะสมาชิกและยอดรวม:
  - ถ้าเป็น 'Y' คำนวณยอดสุทธิ = total * 0.95
  - ถ้าเป็น 'N' และ total >= 500 คำนวณยอดสุทธิ = total * 0.97
  - กรณีอื่น ๆ ยอดสุทธิ = total
Step 4: บวกค่าเล็กน้อย (+0.001) เพื่อป้องกันปัญหา Floating-point precision เมื่อแสดงผลทศนิยม 2 ตำแหน่ง
Step 5: แสดงผลลัพธ์เป็นทศนิยม 2 ตำแหน่งด้วย f-string
```
...
```text
ทดสอบเงื่อนไขแรกเมื่อสถานะเป็นสมาชิก 'Y'
```
...
```text
ทดสอบเงื่อนไขไม่เป็นสมาชิกแต่ซื้อถึงเกณฑ์ขั้นต่ำ 500 บาท
```
...
```text
ทดสอบกรณีที่ไม่เข้าเงื่อนไขรับส่วนลด
```
