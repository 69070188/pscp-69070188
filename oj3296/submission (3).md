...
```text
โจทย์ให้รับค่า RGB ของสี 2 สี แล้วหาค่าเฉลี่ยของ R, G, B แต่ละช่องเพื่อสร้างสีใหม่

Input: รับค่า RGB 2 ชุด

Output: แสดงค่า RGB ของสีที่ผสมแล้ว

Constraints: ค่า RGB อยู่ระหว่าง 0-255 และใช้ค่าเฉลี่ยแบบจำนวนเต็ม
```
...
```text
1.รับค่า RGB ของสีทั้ง 2 สี
2.นำค่า R มาบวกกันแล้วหาร 2
3.ทำแบบเดียวกันกับ G และ B
4.แสดงค่า RGB ที่ได้
```
...
```text
ทดสอบกรณีที่สีทั้งสองเหมือนกัน
```
...
```text
ทดสอบค่าที่เป็นเลขคี่เพื่อดูว่าการหารแบบจำนวนเต็มทำงานถูกต้อง
```
