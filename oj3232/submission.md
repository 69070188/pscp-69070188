...
```text
โจทย์ให้หาจำนวนครั้งที่กบน้อยต้องกระโดดเพื่อให้ระยะทางรวมถึง Y โดยครั้งแรกกระโดด X เมตร และครั้งต่อไปลดลง 2 เมตร

Input: รับค่า X และ Y

Output: แสดงจำนวนครั้งที่กระโดด หรือ -1 ถ้าไปไม่ถึง

Constraints: 1 <= X <= 1000 และ 1 <= Y <= 100000
```
...
```text
1.รับค่า X และ Y
2.ตั้งระยะทางรวมและจำนวนครั้งกระโดดเป็น 0
3.วนลูปจนกว่าระยะรวมจะถึง Y
4.เพิ่มระยะกระโดดและจำนวนครั้ง
5.ลดระยะกระโดดครั้งละ 2
6.ถ้าระยะกระโดดเหลือ 0 หรือต่ำกว่า ให้ตอบ -1
```
...
```text
ทดสอบกรณีที่กระโดดหลายครั้งและครั้งสุดท้ายถึงเป้าหมายพอดี
```
...
```text
ทดสอบกรณีที่ครั้งแรกกระโดดเกินระยะเป้าหมาย
```
...
```text
ทดสอบกรณีที่ระยะกระโดดลดลงจนไปไม่ถึงเป้าหมาย
```
