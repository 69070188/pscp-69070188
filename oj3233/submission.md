...
```text
โจทย์ให้ตรวจรางวัลจากหมวดตัวอักษรและเลขสลาก 5 หลัก โดยต้องเลือกรางวัลที่มีมูลค่าสูงที่สุดเพียงรางวัลเดียว

Input: รับผลรางวัล 1 บรรทัด และเลขสลากที่ซื้อ 1 บรรทัด

Output: แสดงจำนวนเงินรางวัลที่ได้รับ หรือ 0 ถ้าไม่ถูกรางวัล

Constraints: ต้องตรวจทั้งตัวอักษร เลข 5 หลัก และเลขท้าย 2 หรือ 3 ตัว
```
...
```text
1.รับข้อมูลเลขที่ออกและเลขที่ซื้อ
2.เปรียบเทียบตัวอักษร
3.เปรียบเทียบเลขทั้ง 5 หลัก
4.ตรวจเลขท้าย 2 และ 3 ตัว
5.เลือกรางวัลที่มากที่สุด
6.แสดงเงินรางวัล
```
...
```text
ทดสอบเลขท้าย 2 ตัวตรงและตัวอักษรตรงกัน
```
...
```text
ทดสอบเลขท้าย 3 ตัวตรง แต่ตัวอักษรไม่ตรง
```
...
```text
ทดสอบกรณีที่ไม่ตรงกับเงื่อนไขรางวัลใดเลย
```
