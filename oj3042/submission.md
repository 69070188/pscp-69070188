...
```text
โจทย์ให้รับจำนวนเต็มบวก N แล้วหาตัวเลขตั้งแต่ N ถึง 0 ที่หารด้วย 10 ลงตัว
Input: รับจำนวนเต็มบวก N
Output: แสดงตัวเลขที่หารด้วย 10 ลงตัว โดยคั่นด้วยช่องว่าง
Constraints: ตัวเลขต้องอยู่ในช่วง N ถึง 0
```
...
```text
รับค่า N
วนลูปจาก N ลงไปถึง 0
ตรวจว่าตัวเลขหารด้วย 10 ลงตัวหรือไม่
ถ้าลงตัวให้แสดงตัวเลขนั้น
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรกผมใช้ range(n, -1, -1) เพื่อวนจาก N ลงมาถึง 0 และใช้ % 10 ตรวจว่าหารด้วย 10 ลงตัวหรือไม่
```
...
```text
ทดสอบค่าปกติที่มีหลายตัวเลขหารด้วย 10 ลงตัว
```
...
```text
ทดสอบกรณีที่ N หารด้วย 10 ลงตัวพอดี
```
...
```text
ทดสอบกรณีที่ N น้อยกว่า 10 จะมีเพียง 0 ที่หารด้วย 10 ลงตัว
```
