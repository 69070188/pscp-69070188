...
```text
โจทย์ให้ระบุว่าถ้าเกิด คนที่คะแนนมากสุดกับน้อยสุดห่างกันสองคะแนน จะ เซอร์ไพรส์แต่ถ้าไม่ จะไม่เซอร์ไพรซ์
input คือคะแนนรวมของทั้ง 3 คน และคะแนนสูงสุดของทั้ง 3 คนนี้
output คือ เซอร์ไพรซ์กะไม่เซอร์ไพรซ์
```
...
```text
Step 1: รับ input
Step 2: ให้คะแนนคนที่อยู่ตรงกลางได้คะแนนเท่ากับคนที่ได้มากที่สุด
Step 3: คำนวนหาคะแนนคนที่ได้ต่ำสุด
Step 4: คำนวนส่วนต่างของคะแนนต่ำสุดกับมากสุด
Step 5: แสดงผลตามที่โจทย์ต้องการ
...
```text
ลองให้ output ออกเป็น Not surprising
```
...
```text
ช่วยดู code อีกแบบนึงโดยการใช้ max
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ด คิดวิธีแก้ไขปัญหาโจทย์ คิดสมการ 
```
