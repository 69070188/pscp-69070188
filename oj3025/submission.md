...
```text
โจทย์ให้เราหาว่าเป็นฤดูไหนของเดือนและวันจาก input ของเราโดยที่เดือนที่ 1, 2, 3 เป็น ฤดูหนาว 
เดือน 4, 5, 6 เป็น ฤดูใบไม้ผลิ เดือนที่ 7, 8, 9 เป็น ฤดูร้อน
เดือน 10, 11, 12 เป็น ฤดูใบไม้ร่วง แต่ตั้งแต่วันที่ 21 ขี้นไป ของเดือนที่หาร 3 ลงตัว ฤดูจะเปลี่ยนไป
```
...
```text
Step 1:รับ input
Step 2: สร้างตัวแปลที่หาร 3 ลงตัว
Step 3: กำหนดแต่ละฤดูของแต่ละเดือน
Step 4: เทียบกับเดือนที่หาร 3 ลงตัว เพื่อหาฤดูตั้งแต่วันที่ 21 เป็นต้นไป
```
...
```text
คิดว่าอยากลองว่าถ้าไม่ใช่เดือนที่ 3 แต่วันมากกว่า 21 จะเปลี่ยนฤดูไหม
```
...
```text
ลองเดือนที่ 3 หารลงตัวและวันมากกว่า 21
```
...
```text
ลองเดือนที่ 3 หารลงตัวแต่วันต่ำกว่าวันที่ 21
```
...
```text
ช่วยแนะนำโค้ดว่าควรเขียนยังไง
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดด้วยตัวเองแต่ทำการปรึกษาเพื่อนบ้างในโค้ดที่จำไม่ได้
```
