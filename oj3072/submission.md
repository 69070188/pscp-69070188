...
```text
โจทย์ให้รับข้อความ 1 ข้อความ (ความยาว 1 ถึง 999 ตัวอักษร) แล้วนับจำนวนสระภาษาอังกฤษ (a, e, i, o, u) โดยไม่สนใจตัวพิมพ์เล็กหรือตัวพิมพ์ใหญ่ และพิมพ์เฉพาะสระที่มีปรากฏในข้อความออกมาพร้อมจำนวนที่นับได้
Input: ข้อความ 1 บรรทัด
Output: พิมพ์สระแต่ละตัวที่มีในข้อความคู่กับจำนวนที่พบโดยแสดงเฉพาะตัวที่พบอย่างน้อย 1 ครั้ง
Constraints: ไม่สนใจตัวพิมพ์เล็ก/ใหญ่ และนับสระเฉพาะ a, e, i, o, u เท่านั้น
```
...
```text
Step 1: ในเมื่อเขาบอกว่าไม่สนขนาดเลยกำหนดให้เป็นตัวเล็กโดยรับข้อความแล้วแปลงเป็นตัวพิมพ์เล็กทั้งหมดด้วย .lower()
Step 2: เช็คสระ 'a' ถ้ามีในข้อความ ให้ใช้วิธีนับจำนวนและพิมพ์ออกมา
Step 3: ทำซ้ำ Step 2 กับสระ 'e', 'i', 'o', 'u' ตามลำดับ
Step 4: สระตัวใดที่ไม่ปรากฏในข้อความจะไม่พิมพ์ออกมา
```
...
```text
ตรวจสอบว่าโปรแกรมแสดงผลเฉพาะสระที่พบจริงหรือไม่
```
