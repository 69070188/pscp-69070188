...
```text
โจทย์ให้รับชื่อไพ่ แล้วแปลงเป็นชื่อเต็มของแต้มไพ่และดอกไพ่ เช่น QS เป็น queen of spades โดยรับได้ทั้งตัวพิมพ์ใหญ่และพิมพ์เล็ก
Input: รับค่าไพ่ 1 ใบ 
Output: แสดงชื่อเต็มของไพ่
```
...
แผนแรกของฉัน
1.รับข้อมูลไพ่
2.แยกแต้มไพ่ออกจากดอกไพ่
3.เปลี่ยนตัวอักษรเป็นตัวพิมพ์ใหญ่
4.ตรวจและแปลงชื่อแต้มไพ่กับดอกไพ่
5.แสดงชื่อเต็ม
```
...
```text
ทดสอบไพ่ที่แต้มเป็น K และดอกเป็นดอกจิก
```
...
```text
ทดสอบไพ่แต้ม 2 กับดอกข้าวหลามตัด
```
...
```text
ทดสอบตัวพิมพ์เล็กทั้งแต้มและดอก
```
