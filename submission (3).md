...
```text
โจทย์ให้รับข้อความ 5 บรรทัด แล้วนำข้อความทั้งหมดมาแสดงในกรอบสี่เหลี่ยม โดยเติมช่องว่างให้ข้อความแต่ละบรรทัดยาวเท่ากัน
Input: รับข้อความ 5 บรรทัด
Output: แสดงข้อความในกรอบ * จำนวน 7 บรรทัด
Constraints: กรอบต้องมีช่องว่างระหว่างข้อความกับขอบด้านละ 1 ช่อง
```
...
```text
1.รับข้อความ 5 บรรทัด
2.หาความยาวของข้อความที่ยาวที่สุด
3.เติมช่องว่างให้ข้อความที่สั้นกว่า
4.พิมพ์กรอบด้านบน
5.พิมพ์ข้อความทั้ง 5 บรรทัดในกรอบ
6.พิมพ์กรอบด้านล่าง
```
...
```text
ทดสอบข้อความที่มีความยาวต่างกัน
```
