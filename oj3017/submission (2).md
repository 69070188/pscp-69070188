...
```text
Input:
โปรแกรมรับค่าอาหารและเครื่องดื่มมา

Output:
ราคาอาหารและเครื่องดิ่มที่บวกค่าบริการและvat แล้ว

Constraints:
ถ้า ค่าบริการต่ำกว่า 50 จะต้องเพิ่มมาเป็น 50 ถ้าสูงกว่า 1000 จะต้องลดมาเป็น 1000
```
...
```text
Step 1: รับค่าอาหารและเครื่องดื่ม
Step 2: +ค่าบริการ 10% โดยใช้เป็น ค่าบริการ + ( ค่าบริการ * 0.1)เป็นสูตรทางคณิตศาสตร์เนื่องจากการเขียนโค้ดไม่สามารถใช้ % ได้
Step 3: นำราคาที่บวกค่าบริการ 10% แล้วไปบวก vat 7%
Step 4: แสดงผลราคาที่บวกค่าบริการและ vat

ก่อนถามเพื่อนผมรู้ว่าควรคิดยังไงแต่ไม่รู้ว่าสามารถใช้โค้ดตัวไหนได้บ้าง
```
...
```text
วิธีสุดท้ายเหมือนแผนแรกแต่เพิ่มเงื่อนไข ถ้าค่าบริการต่ำกว่า 50 ให้เพิ่มเป็น 50 ถ้าสูงกว่า 1000 ให้ลดเป็น 1000
และแสดงผลโดย ใส่ค่าเป็นจุดทศนิยม 2 ตำแหน่ง
...
```text
ลองให้ค่าบริการอยู่ในช่วง 50-1000
```
...
```text
ช่วยบอกวิธีเขียนโค้ดตรงที่ค่าบริการต่ำกว่า 50 ต้องเป็น 50 และสูงกว่า 1000 ต้องเป็น 1000
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำทุกอย่างยกเว้นในส่วนที่ถามเพื่อนครับ
```
