...
```text
โจทย์ให้รับขนาดแถบ L และจำนวนช่องที่ปลูก N แล้วหาว่าช่องสุดท้ายที่ปลูกอยู่ในแถบที่เท่าไร
Input: รับ L และ N
Output: แสดงหมายเลขแถบของช่องสุดท้าย
Constraints: 1 <= L <= 10 และ 1 <= N <= 100000
```
...
```text
1.รับค่า L และ N
2.คำนวณจำนวนช่องที่เพิ่มขึ้นในแต่ละแถบ
3.หาว่าต้องใช้กี่แถบจึงจะครอบคลุม N
4.นำจำนวนแถบไปคำนวณตามขนาด L
5.แสดงหมายเลขแถบ
```
...
```text
เหมือนกับแผนแรก ผมใช้ while เพิ่มจำนวนช่องตามลำดับของแถบ แล้วใช้ ceil หาจำนวนแถบตามขนาด L
```
...
```text
ทดสอบกรณี L = 1 และจำนวนช่องไม่มาก
```
...
```text
ทดสอบจำนวนช่องที่อยู่ตรงรอยต่อของแถบ
```
