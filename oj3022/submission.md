...
```text
โจทย์ให้ผมคำนวนจาก input ที่รับมา
Input:
รับค่าตัวแปลเข้ามา
...
Output:
ค่าที่ได้จากการคำนวน

Constraints:
ค่าที่ออกมาจะได้เป็น float และเป็นทศนิยมสองตำแหน่ง
```
...
```text
Step 1: รับค่า input
Step 2: คำนวนหาค่า C ในทุกสมการ
Step 3: นำค่า C ไปเทียบจาก input ว่าอยู่สมการไหน
Step 4: คำนวนหาค่าที่ต้องการจาก input
Step 5: แสดง output ออกมา

ก่อนถามเพื่อน ฉันรู้อยู่แล้วว่าควรใช้สมการยังไง
```
...
```text
เขาช่วยเช็คสมการที่ผมย้ายข้างผิด
```

คุณยังทำอะไรด้วยตนเอง

```text
ยังเขียน code และหาวิธีแก้โจทย์ด้วยตัวเองครับ
```
